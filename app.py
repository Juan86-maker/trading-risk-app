        ...
        if submitted:
            ...
            if lote is None or precio is None:
                ...
                datos = {
                    ...
                    "Símbolo": symbol,
                    "Tipo": side,
                    "Lote": f"{lote:.2f}".replace(".", ",") if lote is not None else "",
                    "Precio": f"{precio:.2f}".replace(".", ",") if precio is not None else "",
                    "Stop Loss": f"{sl:.2f}".replace(".", ",") if sl is not None else "",
                    "Take Profit": f"{tp:.2f}".replace(".", ",") if tp is not None else "",
                    "Margen": f"{margen:.2f}".replace(".", ",") if margen is not None else "",
                    "Riesgo": f"{riesgo:.2f}".replace(".", ",") if riesgo is not None else "",
                    "Beneficio": f"{beneficio:.2f}".replace(".", ",") if beneficio is not None else "",
